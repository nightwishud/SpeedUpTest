...
public class FarrDump implements Opcodes {
	...
	public static byte[] dump() throws Exception {
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "farr",
					"([Lcn/edu/pku/plde/rec/A;)V", null, null);
			mv.visitCode();
			mv.visitLdcInsn("farr");
			...
			mv.visitTypeInsn(NEW, "cn/edu/pku/plde/rec/ArrayValue");
			mv.visitInsn(DUP);
			mv.visitLdcInsn("A[] array TYPE");
			mv.visitMethodInsn(INVOKESPECIAL, "cn/edu/pku/plde/rec/ArrayValue",
					"<init>", "(Ljava/lang/String;)V");
			mv.visitVarInsn(ASTORE, 3);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitVarInsn(ALOAD, 3);
			mv.visitTypeInsn(CHECKCAST, "cn/edu/pku/plde/rec/ArrayValue");
			mv.visitMethodInsn(INVOKESTATIC, "cn/edu/pku/plde/rec/Record",
					"analzArray",
					"(Ljava/lang/Object;Lcn/edu/pku/plde/rec/ArrayValue;)V");
			mv.visitLabel(l1);
			mv.visitFrame(Opcodes.F_APPEND, 1,
