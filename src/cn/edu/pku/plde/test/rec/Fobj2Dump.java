...
public class Fobj2Dump implements Opcodes {
	...
	public static byte[] dump() throws Exception {
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "fobj2",
					"(Lcn/edu/pku/plde/rec/A;Lcn/edu/pku/plde/rec/B;I)V", null,
					null);
			mv.visitCode();
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "cn/edu/pku/plde/rec/Record",
					"putPrimPara", "(ILjava/lang/String;Ljava/lang/Object;)V");
			//
			mv.visitVarInsn(ALOAD, 4);
